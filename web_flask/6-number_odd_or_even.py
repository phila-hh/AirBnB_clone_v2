...
def number_odd_or_even(n):
    """
        Flask route at /number_odd_or_even/<int:n> (http://0.0.0.0:5000/).
        Displays 6-number_odd_or_even.html template with value of <n>
    """
    return render_template("6-number_odd_or_even.html", number=escape(n))
